...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <footer class="bg-mc-black border-t border-mc-gray-800">
      <div class="container mx-auto px-4 md:px-6 py-12">
        ...
        <div class="border-t border-mc-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-mc-text-tertiary font-mc text-mc-sm">
          <p>&copy; 2024 MentorMatch. Todos os direitos reservados.</p>
          <div class="flex space-x-6 mt-4 md:mt-0">
            <a href="#" class="hover:text-mc-white transition-colors">Privacidade</a>
            <a href="#" class="hover:text-mc-white transition-colors">Termos</a>
            <a href="#" class="hover:text-mc-white transition-colors">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
